...
export const Textboxalignmiddle24RegularIcon: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M7.75 13.1C7.39102 13.1 7.1 13.391 7.1 13.75C7.1 14.109 7.39102 14.4 7.75 14.4H16.25C16.609 14.4 16.9 14.109 16.9 13.75C16.9 13.391 16.609 13.1 16.25 13.1H7.75Z" fill="black"/>
