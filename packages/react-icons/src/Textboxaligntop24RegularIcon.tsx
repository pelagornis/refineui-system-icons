...
export const Textboxaligntop24RegularIcon: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M7.75 11.1C7.39102 11.1 7.1 11.391 7.1 11.75C7.1 12.109 7.39102 12.4 7.75 12.4H16.25C16.609 12.4 16.9 12.109 16.9 11.75C16.9 11.391 16.609 11.1 16.25 11.1H7.75Z" fill="black"/>
