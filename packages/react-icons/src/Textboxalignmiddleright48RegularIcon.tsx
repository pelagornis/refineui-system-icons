...
export const Textboxalignmiddleright48RegularIcon: React.FC<IconProps> = ({ 
  size = 48, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M20.5 26.2C19.782 26.2 19.2 26.782 19.2 27.5C19.2 28.218 19.782 28.8 20.5 28.8H32.5C33.218 28.8 33.8 28.218 33.8 27.5C33.8 26.782 33.218 26.2 32.5 26.2H20.5Z" fill="black"/>
