...
export const Textboxalignmiddle48RegularIcon: React.FC<IconProps> = ({ 
  size = 48, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M15.5 26.2C14.782 26.2 14.2 26.782 14.2 27.5C14.2 28.218 14.782 28.8 15.5 28.8H32.5C33.218 28.8 33.8 28.218 33.8 27.5C33.8 26.782 33.218 26.2 32.5 26.2H15.5Z" fill="black"/>
