...
export const Battery9048RegularIcon: React.FC<IconProps> = ({ 
  size = 48, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M14 18C12.8954 18 12 18.8954 12 20V28C12 29.1046 12.8954 30 14 30H29.2C30.3046 30 31.2 29.1046 31.2 28V20C31.2 18.8954 30.3046 18 29.2 18H14Z" fill="black"/>
