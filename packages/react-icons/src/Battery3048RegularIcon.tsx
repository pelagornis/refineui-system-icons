...
export const Battery3048RegularIcon: React.FC<IconProps> = ({ 
  size = 48, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M14 18C12.8954 18 12 18.8954 12 20V28C12 29.1046 12.8954 30 14 30H17.2C18.3046 30 19.2 29.1046 19.2 28V20C19.2 18.8954 18.3046 18 17.2 18H14Z" fill="black"/>
