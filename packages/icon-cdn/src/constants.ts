...
export const ICON_METADATA = {
  ...
  icons: [
    ...
    'flash_off', 'flashlight', 'flashlight_off', 'flip_horizontal', 'flip_verticial',
    ...
    'moon', 'more_circle', 'more_horizontal', 'more_verticial', 'mouse', 'movie',
