...
export const Textboxaligntopleft24RegularIcon: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M7.75 11.1C7.39102 11.1 7.1 11.391 7.1 11.75C7.1 12.109 7.39102 12.4 7.75 12.4H13.75C14.109 12.4 14.4 12.109 14.4 11.75C14.4 11.391 14.109 11.1 13.75 11.1H7.75Z" fill="black"/>
