...
export const Textboxalignmiddleleft24RegularIcon: React.FC<IconProps> = ({ 
  size = 24, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M7.75 13.1C7.39102 13.1 7.1 13.391 7.1 13.75C7.1 14.109 7.39102 14.4 7.75 14.4H13.75C14.109 14.4 14.4 14.109 14.4 13.75C14.4 13.391 14.109 13.1 13.75 13.1H7.75Z" fill="black"/>
