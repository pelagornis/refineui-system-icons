...
export const Textboxalignmiddleleft20RegularIcon: React.FC<IconProps> = ({ 
  size = 20, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M6.12422 10.5814C5.82514 10.5814 5.58269 10.8239 5.58269 11.123C5.58269 11.422 5.82514 11.6645 6.12422 11.6645H11.123C11.422 11.6645 11.6645 11.422 11.6645 11.123C11.6645 10.8239 11.422 10.5814 11.123 10.5814H6.12422Z" fill="black"/>
