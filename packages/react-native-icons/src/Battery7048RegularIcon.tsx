...
export const Battery7048RegularIcon: React.FC<IconProps> = ({ 
  size = 48, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M14 18C12.8954 18 12 18.8954 12 20V28C12 29.1046 12.8954 30 14 30H25.2C26.3046 30 27.2 29.1046 27.2 28V20C27.2 18.8954 26.3046 18 25.2 18H14Z" fill="black"/>
