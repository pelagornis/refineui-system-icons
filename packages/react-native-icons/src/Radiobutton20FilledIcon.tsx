...
export const Radiobutton20FilledIcon: React.FC<IconProps> = ({ 
  size = 20, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M9.66667 13.8333C11.9679 13.8333 13.8333 11.9679 13.8333 9.66667C13.8333 7.36548 11.9679 5.5 9.66667 5.5C7.36548 5.5 5.5 7.36548 5.5 9.66667C5.5 11.9679 7.36548 13.8333 9.66667 13.8333Z" fill="black"/>
