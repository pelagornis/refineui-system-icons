...
export const Radiobutton32FilledIcon: React.FC<IconProps> = ({ 
  size = 32, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M15.6667 22.3333C19.3486 22.3333 22.3333 19.3486 22.3333 15.6667C22.3333 11.9848 19.3486 9 15.6667 9C11.9848 9 9 11.9848 9 15.6667C9 19.3486 11.9848 22.3333 15.6667 22.3333Z" fill="black"/>
