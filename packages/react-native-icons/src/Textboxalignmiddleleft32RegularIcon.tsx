...
export const Textboxalignmiddleleft32RegularIcon: React.FC<IconProps> = ({ 
  size = 32, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M10 17.1333C9.52135 17.1333 9.13333 17.5214 9.13333 18C9.13333 18.4786 9.52135 18.8667 10 18.8667H18C18.4786 18.8667 18.8667 18.4786 18.8667 18C18.8667 17.5214 18.4786 17.1333 18 17.1333H10Z" fill="black"/>
