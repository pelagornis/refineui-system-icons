...
export const Clock28RegularIcon: React.FC<IconProps> = ({ 
  size = 28, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M15.0917 9.08333C15.0917 8.66452 14.7521 8.325 14.3333 8.325C13.9145 8.325 13.575 8.66452 13.575 9.08333V14.4058C13.575 14.5605 13.6365 14.7089 13.7459 14.8183L17.2971 18.3696C17.5933 18.6657 18.0734 18.6657 18.3696 18.3696C18.6657 18.0734 18.6657 17.5933 18.3696 17.2971L15.2625 14.1901C15.1531 14.0807 15.0917 13.9323 15.0917 13.7776V9.08333Z" fill="black"/>
