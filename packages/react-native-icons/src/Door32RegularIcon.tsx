...
export const Door32RegularIcon: React.FC<IconProps> = ({ 
  size = 32, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M13.3333 15.6667C13.3333 16.403 12.7364 17 12 17C11.2636 17 10.6667 16.403 10.6667 15.6667C10.6667 14.9303 11.2636 14.3333 12 14.3333C12.7364 14.3333 13.3333 14.9303 13.3333 15.6667Z" fill="black"/>
