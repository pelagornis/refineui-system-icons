...
export const Recordstop28RegularIcon: React.FC<IconProps> = ({ 
  size = 28, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M11.7083 10.8333C11.2251 10.8333 10.8333 11.2251 10.8333 11.7083V16.9583C10.8333 17.4416 11.2251 17.8333 11.7083 17.8333H16.9583C17.4416 17.8333 17.8333 17.4416 17.8333 16.9583V11.7083C17.8333 11.2251 17.4416 10.8333 16.9583 10.8333H11.7083Z" fill="black"/>
