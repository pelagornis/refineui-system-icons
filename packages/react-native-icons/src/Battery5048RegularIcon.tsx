...
export const Battery5048RegularIcon: React.FC<IconProps> = ({ 
  size = 48, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M14 18C12.8954 18 12 18.8954 12 20V28C12 29.1046 12.8954 30 14 30H21.2C22.3046 30 23.2 29.1046 23.2 28V20C23.2 18.8954 22.3046 18 21.2 18H14Z" fill="black"/>
