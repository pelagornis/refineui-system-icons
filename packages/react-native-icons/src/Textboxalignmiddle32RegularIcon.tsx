...
export const Textboxalignmiddle32RegularIcon: React.FC<IconProps> = ({ 
  size = 32, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M10 17.1333C9.52135 17.1333 9.13333 17.5214 9.13333 18C9.13333 18.4786 9.52135 18.8667 10 18.8667H21.3333C21.812 18.8667 22.2 18.4786 22.2 18C22.2 17.5214 21.812 17.1333 21.3333 17.1333H10Z" fill="black"/>
