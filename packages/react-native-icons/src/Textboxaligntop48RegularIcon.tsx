...
export const Textboxaligntop48RegularIcon: React.FC<IconProps> = ({ 
  size = 48, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M15.5 22.2C14.782 22.2 14.2 22.782 14.2 23.5C14.2 24.218 14.782 24.8 15.5 24.8H32.5C33.218 24.8 33.8 24.218 33.8 23.5C33.8 22.782 33.218 22.2 32.5 22.2H15.5Z" fill="black"/>
