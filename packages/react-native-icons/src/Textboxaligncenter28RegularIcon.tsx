...
export const Textboxaligncenter28RegularIcon: React.FC<IconProps> = ({ 
  size = 28, 
  color = 'currentColor', 
  ...props 
}) => {
...
<path d="M10.8333 15.6167C10.4145 15.6167 10.075 15.9562 10.075 16.375C10.075 16.7938 10.4145 17.1333 10.8333 17.1333H17.8333C18.2521 17.1333 18.5917 16.7938 18.5917 16.375C18.5917 15.9562 18.2521 15.6167 17.8333 15.6167H10.8333Z" fill="black"/>
